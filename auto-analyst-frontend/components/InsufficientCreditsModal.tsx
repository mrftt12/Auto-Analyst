    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="flex flex-col items-center">
          ...
          <DialogTitle className="text-center text-xl text-red-500">Insufficient Credits</DialogTitle>
        </DialogHeader>
        ...
        <div className="py-4">
          ...
          <p className="text-center text-gray-700 mb-4">
            This operation requires <span className="font-bold">{requiredCredits} credits</span>.
          </p>
          
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <h3 className="font-medium mb-2 text-black">Options:</h3>
        ...
        <DialogFooter className="flex flex-col sm:flex-row gap-2">
          <Button
            variant="outline"
            onClick={onClose}
            className="sm:flex-1 border-[#FF7F7F] text-[#FF7F7F] hover:bg-[#FFE5E5] hover:text-[#FF6666]"
          >
            Close
          </Button>
