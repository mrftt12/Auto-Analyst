  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4">
      ...
      <nav className="space-y-1">
        ...
        {/* Code Execution Analytics - New Section */}
        <div className="pt-2 border-t border-gray-200">
          <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 pt-2">
            Code Execution
          </h3>
          ...
          <Link 
            ...
            className={`flex items-center px-3 py-2 text-sm rounded-md ${
              pathname === '/analytics/code-executions' ? activeClass : inactiveClass
            }`}
          >
            <svg className="mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link 
            ...
            className={`flex items-center px-3 py-2 text-sm rounded-md ${
              pathname === '/analytics/code-errors' ? activeClass : inactiveClass
            }`}
          >
            <svg className="mr-3 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
