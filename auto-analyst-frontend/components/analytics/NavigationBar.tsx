            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              <Link href="/">
                <span className={`inline-flex items-center px-1 pt-1 border-b-2 ${
                  router.pathname === '/' ? 'border-[#FF7F7F] text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                } text-sm font-medium`}>
                  Home
                </span>
              </Link>
              <Link href="/analytics/dashboard">
                <span className={`inline-flex items-center px-1 pt-1 border-b-2 ${
                  router.pathname.startsWith('/analytics') ? 'border-[#FF7F7F] text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                } text-sm font-medium`}>
                  Analytics
                </span>
              </Link>
              <Link href="/chat">
                <span className={`inline-flex items-center px-1 pt-1 border-b-2 ${
                  router.pathname === '/chat' ? 'border-[#FF7F7F] text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                } text-sm font-medium`}>
                  Chat
                </span>
              </Link>
